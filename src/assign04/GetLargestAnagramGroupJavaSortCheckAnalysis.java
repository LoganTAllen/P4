...
/**
 * This program checks the collected run times of the AnagramChecker's getLargestAnagramGroup
 * method that implements a Java sort by conducting the following tests. This is done
 * to ensure that the expected Big-O behavior matches the behavior of the collected run times
 * to check correct implementation of the method:
 ...
 */
public class GetLargestAnagramGroupJavaSortCheckAnalysis {
	...
	public static void main(String[] args) {
		...
		String fileName = "src/assign04/getLargestAnagramGroupJavaSortRunTimes.txt";
		Scanner fileRead;
		try {
